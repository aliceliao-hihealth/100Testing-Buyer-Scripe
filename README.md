...
**網頁版（建議）**：<https://aliceliao-hihealth.github.io/100Testing-Buyer-Scripe/>

100 列均已載明執行日期、時段、裝置、商品與數量、取貨方式與應執行動作
...
| [賣家側｜任務分配](https://aliceliao-hihealth.github.io/100Testing-SellerTasK/) | 倉儲／營運／財會三類作業的負責事項、前置作業、訂單終態分流與作業要點 |
...
| `buyer_script.md` | Markdown 原始檔，供改版時比對差異 |
